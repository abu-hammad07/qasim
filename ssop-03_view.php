                        ...
                        <div class="card stretch stretch-full">
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <div class="header">PRE-OP/OPERATIONAL INSPECTION CONTINUOUS COMMENT SHEET</div>
                                    <table>
                                        <thead>
                                            <tr>
                                                <th class="check-time">Date of Check</th>
                                                <th class="check-time">Time Completed</th>
                                                <th class="check-person">Person of Check</th>
                                            </tr>
                                            <tr>
                                                <td class="check-time" id="date"><?= $row['created_date'] ?></td>
                                                <td class="check-time"><?= $row['time_completed'] ?></td>
                                        ...
                                        <tbody>
                                            <tr>
                                                <th>1. Date</th>
                                                <td colspan="2" class=""><?= $row['date'] ?></td>
                                            </tr>
                                            <tr>
                                                <th>2. SSOP Form #</th>
                                                <td colspan="2" class=""><?= $row['ssop_form_number'] ?></td>
                                            </tr>
                                            <tr>
                                                <th>3. Area Number</th>
                                                <td colspan="2" class=""><?= $row['area_number'] ?></td>
                                            </tr>
                                            <tr>
                                                <th>4. Deficiencies</th>
                                                <td colspan="2" class=""><?= $row['deficiencies'] ?></td>
                                            </tr>
                                            <tr>
                                                <th>5. Corrective Actions</th>
                                                <td colspan="2" class=""><?= $row['corrective_actions'] ?></td>
                                            </tr>
                                            <tr>
                                                <th>6. Preventive Actions</th>
                                                <td colspan="2" class=""><?= $row['preventive_actions'] ?></td>
                                            </tr>
                                            <tr>
                                                <th>7. Initial(<20F) </th>
                                                <td colspan="2" class=""><?= $row['initial'] ?></td>
                                            </tr>
