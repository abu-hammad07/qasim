            ...
            <div class="page-header-right ms-auto">
                <div class="page-header-right-items">
                    ...
                    <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                        ...
                        <a href="HACCP-03_add" class="btn btn-primary">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover" id="projectList">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $result = $db->data_not_found('haccp_03');
                                        $no = 1;
                                        ...
                                        ?>
                                                <tr class="single-item">
                                                    <td>
                                                        <div class="item-checkbox ms-1">
                                                            <div class="custom-control custom-checkbox">
                                                                <input type="checkbox" class="custom-control-input checkbox" id="<?= $row['HACCP_03_id']; ?>">
                                                                <label class="custom-control-label" for="<?= $row['HACCP_03_id']; ?>"></label>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td><?php echo $no++; ?></td>
                                                    ...
                                                    <td><?= $row['catching_crew']; ?></td>
                                                    <td><?= $row['grower']; ?></td>

                                                    <td>
                                                        <div class="hstack gap-2 justify-content-end">
                                                            <a href="HACCP_03_view.php?id=<?= $row['HACCP_03_id']; ?>" class="avatar-text avatar-md">
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    <li>
                                                                        <a class="dropdown-item" href="HACCP-03_edit.php?id=<?= $row['HACCP_03_id']; ?>">
                                                                            <i class="feather feather-edit-3 me-3"></i>
                                                                            <span>Edit</span>
                                                                        </a>
                                                                    </li>
                                                                    <li>
                                                                        <a class="dropdown-item" href="files_php/HACCP-03.php?Delete_id=<?= $row['HACCP_03_id']; ?>">
