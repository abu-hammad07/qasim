                            ...
                            <div class="table-responsive">
                                <table class="table table-hover" id="projectList">
                                    ...
                                    <tbody>
                                        ...
                                        $db = new database();
                                        $result = $db->data_not_found('ssop_01');
                                        $no = 1;
                                        ...
                                        ?>
                                                <tr class="single-item">
                                                    <td>
                                                        <div class="item-checkbox ms-1">
                                                            <div class="custom-control custom-checkbox">
                                                                <input type="checkbox" class="custom-control-input checkbox" id="<?= $row['SSOP_01_id']; ?>">
                                                                <label class="custom-control-label" for="<?= $row['SSOP_01_id']; ?>"></label>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td><?php echo $no++; ?></td>
                                                    ...
                                                    <td><?= $row['no_rodent_roaches_gnat']; ?></td>

                                                    <td>
                                                        <div class="hstack gap-2 justify-content-end">
                                                            <a href="ssop-01_view.php?id=<?= $row['SSOP_01_id']; ?>" class="avatar-text avatar-md">
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    <li>
                                                                        <a class="dropdown-item" href="ssop-01_edit.php?id=<?= $row['SSOP_01_id']; ?>">
                                                                            <i class="feather feather-edit-3 me-3"></i>
                                                                            <span>Edit</span>
                                                                        </a>
                                                                    </li>
                                                                    <li>
                                                                        <a class="dropdown-item" href="files_php/SSOP-01.php?Delete_id=<?= $row['SSOP_01_id']; ?>">
