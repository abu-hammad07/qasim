            ...
            <div class="page-header-right ms-auto">
                <div class="page-header-right-items">
                    ...
                    <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                        ...
                        <a href="SSOP-02_add" class="btn btn-primary">
                                ...
                                <table class="table table-hover" id="projectList">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Sno</th>
                                            <th>Date</th>
                                            <th>no condensation</th>
                                            <th>no rodent roaches gnat</th>
                                    ...
                                    <tbody>
                                        ...
                                        $db = new database();
                                        $result = $db->data_not_found('ssop_02');
                                        $no = 1;
                                        ...
                                        ?>
                                                <tr class="single-item">
                                                    <td>
                                                        <div class="item-checkbox ms-1">
                                                            <div class="custom-control custom-checkbox">
                                                                <input type="checkbox" class="custom-control-input checkbox" id="<?= $row['SSOP_02_id']; ?>">
                                                                <label class="custom-control-label" for="<?= $row['SSOP_02_id']; ?>"></label>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td><?php echo $no++; ?></td>
                                                    ...
                                                    <td><?= $row['no_condensation']; ?></td>
                                                    <td><?= $row['no_rodent_activity']; ?></td>

                                                    <td>
                                                        <div class="hstack gap-2 justify-content-end">
                                                            <a href="ssop-02_view.php?id=<?= $row['SSOP_02_id']; ?>" class="avatar-text avatar-md">
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    <li>
                                                                        <a class="dropdown-item" href="ssop-02_edit.php?id=<?= $row['SSOP_02_id']; ?>">
                                                                            <i class="feather feather-edit-3 me-3"></i>
                                                                            <span>Edit</span>
                                                                        </a>
                                                                    </li>
                                                                    <li>
                                                                        <a class="dropdown-item" href="files_php/SSOP-02.php?Delete_id=<?= $row['SSOP_02_id']; ?>">
