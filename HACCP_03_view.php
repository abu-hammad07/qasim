                        ...
                        <div class="card stretch stretch-full">
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <div class="header">Strause's Catching Service - Load Out Slip</div>
                                    <table>
                                        <thead>
                                            <tr>
                                                <th class="check-time">1. Date</th>
                                                <th class="check-time">2. Catching Crew</th>
                                           
                                            </tr>
                                            <tr>
                                                <td class="check-time" id="date"><?= $row['load_date'] ?></td>
                                                <td class="check-time"><?= $row['catching_crew'] ?></td>
                                        ...
                                        <tbody>
                                            <tr>
                                                <th>1. Grower</th>
                                                <td colspan="2"><?= $row['grower'] ?></td>
                                            </tr>
                                            <tr>
                                                <th>2. House </th>
                                                <td colspan="2"><?= $row['house'] ?></td>
                                            </tr>
                                            <tr>
                                                <th>3. Pen</th>
                                                <td colspan="2"><?= $row['pen'] ?></td>
                                            </tr>
                                            <tr>
                                                <th>4. Bird Type</th>
                                                <td colspan="2"><?= $row['bird_type'] ?></td>
                                            </tr>
                                            <tr>
                                                <th>5. Coops/Head</th>
                                                <td colspan="2"><?= $row['coops_head'] ?></td>
                                            </tr>
                                            <tr>
                                                <th>6. Total Birds</th>
                                                <td colspan="2"><?= $row['total_birds'] ?></td>
                                            </tr>
                                            <tr>
                                                <th>7. Time Of Arrival</th>
                                                <td colspan="2"><?= $row['time_of_arrival'] ?></td>
                                            </tr>
                                            <tr>
                                                <th>8. Sexing</th>
                                                <td colspan="2"><?= $row['sexing'] ?></td>
                                            </tr>
                                            <tr>
                                                <th>9. Driver</th>
                                                <td colspan="2"><?= $row['driver'] ?></td>
                                            </tr>
                                            <tr>
                                                <th>Comments</th>
