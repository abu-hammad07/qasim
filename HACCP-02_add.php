                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-xl-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="internal_temp_chicken_40F" id="internal-temp" placeholder="Enter Internal Temperature">
                            </div>
                            <div class="col-xl-6 mb-3">
                                <label class="form-label">5. Initials
                                    <span class="text-danger">*</span>
                                </label>
                                <input type="text" class="form-control" name="initials" id="initials" placeholder="Enter Your Initials">
                            </div>
                            <div class="col-xl-6 mb-3">
                                <label class="form-label">6. Pre-shipper signature
                                    <span class="text-danger">*</span>
                                </label>
                                <input type="text" class="form-control" name="pre_shipper_signature" id="pre-shipper-signature" placeholder="Enter Pre-shipper Signature">
                            </div>
                            <div class="col-xl-6 mb-3">
                                <label class="form-label">7. Date
                                    <span class="text-danger">*</span>
                                </label>
                                <input type="date" class="form-control" name="verification_date" id="verification-date" placeholder="Select Date">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-xl-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="verified_initials" id="verified-initials" placeholder="Enter Verified Initials">
                            </div>
                            <div class="col-xl-6 mb-3">
                                <label class="form-label">2. Verified date
                                    <span class="text-danger">*</span>
                                </label>
                                <input type="date" class="form-control" name="verified_date" id="verified-date" placeholder="Select Verified Date">
                            </div>
                            <div class="col-xl-6 mb-3">
                                <label class="form-label">3. Verified time
                                    <span class="text-danger">*</span>
                                </label>
                                <input type="time" class="form-control" name="verified_time" id="verified-time" placeholder="Select Verified Time">
                            </div>
                            <div class="col-xl-6 mb-3">
